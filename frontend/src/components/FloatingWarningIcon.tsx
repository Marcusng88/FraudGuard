  ...
  return (
    <div className="fixed top-4 right-4 z-50 animate-float">
      <div className="relative">
        {/* Outer glow ring */}
        <div className="absolute inset-0 bg-destructive/30 rounded-full blur-xl scale-150 animate-pulse-glow" />
        
        {/* Middle glow */}
        <div className="absolute inset-0 bg-destructive/50 rounded-full blur-lg scale-125 animate-pulse" />
        ...
        {/* Floating particles */}
        <div className="absolute -top-2 -right-2 w-2 h-2 bg-destructive rounded-full animate-ping" />
        <div className="absolute -bottom-1 -left-1 w-1 h-1 bg-destructive/70 rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
      </div>
    </div>
  );
}